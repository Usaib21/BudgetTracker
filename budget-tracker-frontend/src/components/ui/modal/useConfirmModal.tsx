...
export type ConfirmModalType = 'success' | 'info' | 'warning' | 'danger';
...
export function useConfirmModal() {
    ...
    const [type, setType] = useState<ConfirmModalType>('info');
    ...
    const openModal = useCallback((options?: ConfirmModalOptions) => {
        ...
        if (options?.onConfirm) setOnConfirmCallback(() => options.onConfirm!);
        if (options?.onCancel) setOnCancelCallback(() => options.onCancel!);
        setIsOpen(true);
    }, []);
    ...
    const getModalStyles = (modalType: ConfirmModalType) => {
        switch (modalType) {
            case 'success':
                return {
                    bgClass: 'bg-success-500 hover:bg-success-600',
                    icon: (
            ...
            case 'warning':
                return {
                    bgClass: 'bg-warning-500 hover:bg-warning-600',
                    icon: (
                        <div className="relative z-1 mb-7 flex items-center justify-center">
                            <svg
            ...
            case 'danger':
                return {
                    bgClass: 'bg-error-500 hover:bg-error-600',
                    icon: (
                        <div className="relative z-1 mb-7 flex items-center justify-center">
                            <svg
            ...
            default:
                return {
                    bgClass: 'bg-blue-light-500 hover:bg-blue-light-600',
                    icon: (
                        <div className="relative z-1 mb-7 flex items-center justify-center">
                            <svg
    ...
    const ConfirmModal = () => {
        ...
        const { bgClass, icon } = getModalStyles(type);

        return (
            <Modal isOpen={isOpen} onClose={closeModal} className="max-w-[600px] p-5 lg:p-10">
                <div className="text-center">
                    <div className="relative mb-7 flex items-center justify-center">{icon}</div>
                    ...
                    <div className="mt-7 flex items-center justify-center gap-3">
                        <button
                            type="button"
                            className="flex-1 rounded-lg bg-gray-500 px-4 py-3 text-sm font-medium text-white hover:bg-gray-600"
                        ...
                        <button
                            type="button"
                            className={`flex-1 rounded-lg px-4 py-3 text-sm font-medium text-white ${bgClass}`}
